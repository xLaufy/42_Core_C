...
/*
	Główna funkcja "ft_split" najpierw sprawdza,czy ciag "s" jest pusty. Jesli tak,
	zwraca "NULL". Nastepnie alokuje pamiec na tablice "result" i wypełnia
	podciagami z "s" za pomoca funkcji write_to_array. Jesli alokacja pamieci nie
	powiedzie sie, funkcja zwalnia pamiec i zwraca NULL. W przeciwnym razie zwraca
	tablice result.
*/
